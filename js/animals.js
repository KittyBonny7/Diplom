document.querySelector(".Opros_1").querySelector(".opros").onsubmit = (
    ...
    const radioButtonsFirst = document.querySelectorAll('input[name="q1"]');
    ...
    const radioButtonsSecond = document.querySelectorAll('input[name="q2"]');
    let selectedq2;
    ...
    const radioButtonsThird = document.querySelectorAll('input[name="q3"]');
    let selectedq3;
